...
export async function createHomeLS3LaunchDialog(
    ctx: OnyxiaCtx
): Promise<{ HomeLS3LaunchDialog: ComponentType<Props_HomeLS3LaunchDialog> }> {
    const [
        React,
        { useEvt },
        { tss },
        ...
        ctx.import("@mui/material/styles"),
        ctx.import("tss-react"),
        ctx.import("tsafe"),
    ...
    const id: typeof import("tsafe").id = tsafe.id;

    function HomeLS3LaunchDialog(props: Props_HomeLS3LaunchDialog) {
        const { evtOpen } = props;
    ...
    function GitLabRepoView(props: {
        ...
        const { gitlabRepoUrlHistory, setGitlabRepoUrlHistory } =
            useGitlabRepoUrlHistory();
            ...
            <div className={cx(classes.root, className)}>
                ...
                <div className={classes.actionWrapper}>
                    <Button
                        ...
                        onClick={() => {
                            setGitlabRepoUrlHistory([
                                ...gitlabRepoUrlHistory,
                                gitlabRepoUrl
                            ]);
